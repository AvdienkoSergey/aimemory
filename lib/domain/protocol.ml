...
and entity_input = { lid : Lid.t; data : Entity.data; refs : ref_input list }
and ref_input = { target : Lid.t; rel : Ref.rel }
...
and entities_result = { items : Entity.processed list; page : page_info }
and refs_result = { items : Ref.resolved list; page : page_info }
